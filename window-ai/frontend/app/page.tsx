    ...
    <div>
      <div className="mb-8 max-w-2xl">
        ...
        <p className="mt-2 text-slate-600">
          Window City v18 is the pricing authority. Add every window for the customer, review internal or customer pricing, and send the finished quote into a project estimate.
        </p>
